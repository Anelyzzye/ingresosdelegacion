	...
	<form action="{{ route('eventos.store')}}" method="POST"   class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto" enctype="multipart/form-data" >
		...
		<div class="col-lg-12">
			<h6 class="heading-small text-muted mb-4">Titulo del evento:</h6>
				<input type="text" name="evento_titulo" class="form-control">
				@if($errors->any())
		...
		<div class="col-lg-12">
			...
			<h6 class="heading-small text-muted mb-4">Texto del evento:</h6>
				...
				<textarea name="evento_texto" class="form-control">
		...
		<div class="col-lg-12">
			...
			<h6 class="heading-small text-muted mb-4">Fecha de la publicación: </h6>
				<input type="date" name="evento_fecha" class="form-control" value="{{now()}}">
				@if($errors->any())
				<div class="alert-danger mb-4">
		...
		<div class="col-lg-9">
			...
			<h6 class="heading-small text-muted mb-4">Imagen del evento:</h6>
				<input type="file" name="evento_image" class="form-control">
				@if($errors->any())
				<div class="alert-danger mb-4">
