                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="apellidomat" type="text" class="form-control @error('apellidomat') is-invalid @enderror" name="apellidomat" value="{{ old('apellidomat') }}" required autocomplete="apellidomat" autofocus>
